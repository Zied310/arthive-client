...
public class ServiceUser implements IService<User> {
    ...
    private edu.esprit.gestiongroupe.utils.DataSource DataSource;
    ...
    public void add(User user) {
        ...
        String req = "INSERT INTO `users`(`nom_user`, `prenom_user`, `email`, `mdp_user`, `d_naissance_user`, `ville`, `num_tel_user`,`role_user`)  VALUES (?,?,?,?,?,?,?,?)";
        try {
    ...
    public User getOneByID(int id) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                Integer numtel = rs.getInt("num_tel_user");
                String role=rs.getString("role_user");
                User user1 = new User (userId,nom,prenom,email,password,dateNaiss,ville,numtel,role);
            }
        } catch (SQLException e) {
            System.out.println(e.getMessage());
        }
